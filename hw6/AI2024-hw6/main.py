...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str,
                        choices=["unsloth/llama-3-8b-bnb-4bit",
                                 "unsloth/mistral-7b-v0.3-bnb-4bit","unsloth/tinyllama-bnb-4bit","unsloth/mistral-7b-instruct-v0.3-bnb-4bit"],
                        required=True)
...
if __name__ == "__main__":
    ...
    if args.inference_base_model:
        if args.model_name == "unsloth/mistral-7b-instruct-v0.3-bnb-4bit":
            print("Inference with base model: unsloth/mistral-7b-instruct-v0.3-bnb-4bit")
            ...
            inference.LLM_inference(args)
        elif args.model_name == "unsloth/llama-3-8b-bnb-4bit":
